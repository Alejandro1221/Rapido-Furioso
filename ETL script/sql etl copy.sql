...
CREATE TABLE IF NOT EXISTS public.tipo_novedad (
    id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY (
        INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1
    ),
    nombre character varying(30) COLLATE pg_catalog."default",
    CONSTRAINT tipo_novedad_pkey PRIMARY KEY (id)
) TABLESPACE pg_default;

ALTER TABLE
    IF EXISTS public.tipo_novedad OWNER to postgres;

INSERT INTO public.tipo_novedad(id, nombre) VALUES ('No puedo continuar'), ('Novedades del servicio');

CREATE TABLE novedades (
    id_novedad SERIAL PRIMARY KEY,
    id_servicio INT REFERENCES servicios(id_servicio) ON DELETE CASCADE,
    descripcion TEXT NOT NULL,
    id_tipo_novedad INT REFERENCES tipo_novedad(id) ON DELETE CASCADE,
    id_mensajero INT REFERENCES mensajero(id_mensajero) ON DELETE CASCADE,
