...
def transferir_clientes():
    ...
    try:
        # Conectar a la base de datos 'bodega_datos' y obtener los registros de la tabla 'cliente'
        with engine_bodega.connect() as conn_bodega:
            # Consulta para obtener los registros de 'cliente' sin valores NULL en los campos necesarios
            query_bodega = text("""
                SELECT cliente_id, nit_cliente, nombre, email, direccion, telefono, nombre_contacto, ciudad_id, tipo_cliente_id, activo, sector
                FROM cliente
        ...
        with engine_etl.connect() as conn_etl:
            for cliente in clientes:
                (cliente_id, nit_cliente, nombre, email, direccion, telefono, nombre_contacto, 
                 ciudad_id, tipo_cliente_id, activo, sector) = cliente

                # Validar que el tipo_cliente_id existe en la tabla tipo_cliente en 'etl_rapidos_furiosos'
                ...
                # Validar que el ciudad_id existe en la tabla ciudad en 'etl_rapidos_furiosos'
                ...
                # Verificar si el cliente ya existe en la base de datos de destino 'etl_rapidos_furiosos'
                ...
                if cliente_existente:
                    ...
                    query_insert = text("""
                        INSERT INTO cliente (id_cliente, nit_cliente, nombre_cliente, email, direccion, telefono_cliente, 
                                             nombre_contacto, id_ciudad, id_tipo_cliente, activo, sector)
                        VALUES (:cliente_id, :nit_cliente, :nombre, :email, :direccion, :telefono, 
                                :nombre_contacto, :ciudad_id, :tipo_cliente_id, :activo, :sector)
                    """)
        ...
        # Mostrar los registros de la tabla 'cliente' en la base de datos de destino 'etl_rapidos_furiosos'
        with engine_etl.connect() as conn_etl:
